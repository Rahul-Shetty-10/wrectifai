...
export function PaymentsClient({ content }: { content: DynamicPageContent }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-[23px] font-semibold text-slate-900 sm:text-[24px]">{t('title', 'Payments')}</h1>
      ...
      <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {currentPayments.map((payment) => (
          <Card key={payment.id} className="rounded-xl border-[#d9e2ef] bg-white shadow-[0_6px_16px_rgba\(94,126,179,0.10\)] ">
